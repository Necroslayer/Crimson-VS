...
// ─────────────────────────────────────────────
// PVP CLIENT — Socket.io connection + matchmaking
// Set PVP_SERVER_URL to your backend's public URL.
// Leave empty to disable PvP (the VS Player card will show "Coming soon").
// ─────────────────────────────────────────────
const PVP_SERVER_URL = "http://localhost:3001"; // local dev backend

const PvpCtx = createContext(null);
function usePvp() { return useContext(PvpCtx); }
...
// ─── DECK BUILDER ─────────────────────────────
const JUNCTION_DESC = {
  "AIDA Berserk": { en: "Start of turn: +2 AP, take 2 damage.", pt: "Início do turno: +2 AP, recebe 2 de dano." },
  "AIDA Corrosion": { en: "Start of your turn: +1 AP, take 1 damage.", pt: "Início do seu turno: +1 AP, recebe 1 de dano." },
  "All At Once": { en: "+2 AP for every junctioned card you hold.", pt: "+2 AP para cada carta juntionada que você possui." },
  "Anu's Karma": { en: "+3 HP at end of your turn if you go second.", pt: "+3 HP no fim do seu turno se você for segundo." },
  "Aurora Tears": { en: "+2 AP at end of your turn if you go first.", pt: "+2 AP no fim do seu turno se você for primeiro." },
  "Avatar's Descent": { en: "+5 AP for 5 turns. Nullify all junction damage from enemy.", pt: "+5 AP por 5 turnos. Anula todo dano de junctions inimigos." },
  "Blades Crossing": { en: "Each time you deal damage, deal +1 extra.", pt: "Cada vez que causar dano, causa +1 extra." },
  "Bone Crunching": { en: "+4 AP, -4 HP immediately.", pt: "+4 AP, -4 HP imediatamente." },
  "Border of Zero": { en: "Both Generals' HP become 1.", pt: "HP de ambos os Generais vira 1." },
  "Burning Soul": { en: "+1 AP each time your HP drops below 50%.", pt: "+1 AP cada vez que seu HP cair abaixo de 50%." },
  "Change Ring": { en: "Swap enemy General's AP and HP values.", pt: "Troca AP e HP do General inimigo." },
  "Charge Ahead": { en: "Your General goes first. Cancelled if both have this.", pt: "Seu General vai primeiro. Cancelado se ambos tiverem." },
  "Clenching Teeth": { en: "Once: if HP hits 0, restore to 1.", pt: "Uma vez: se HP chegar a 0, restaura para 1." },
  "Cross Counter": { en: "When you take damage, deal 1 damage to enemy.", pt: "Quando você recebe dano, causa 1 de dano ao inimigo." },
  "Defensive Stance": { en: "Force your General to go second. -1 damage received.", pt: "Força seu General a ir segundo. -1 dano recebido." },
  "Demon Sword Maxwell": { en: "Nullify all damage from enemy junction abilities.", pt: "Anula todo dano de junctions inimigos." },
  "Demonic Spear": { en: "Deal 7 damage to enemy General immediately.", pt: "Causa 7 de dano ao General inimigo imediatamente." },
  "Detail Oriented": { en: "Damage of 1–2 is reduced to 0. Damage 3+ is normal.", pt: "Dano 1–2 é reduzido a 0. Dano 3+ é normal." },
  "Different Mix": { en: "+2 AP/HP if junctioned with a different trinity. -2 if same.", pt: "+2 AP/HP se juntionado com trinity diferente. -2 se igual." },
  "Divine Punishment": { en: "Deal 5 damage to enemy General immediately.", pt: "Causa 5 de dano ao General inimigo imediatamente." },
  "Double Trigger": { en: "When you deal damage, add +2 extra.", pt: "Quando causar dano, adiciona +2 extra." },
  "Emperor's Pride": { en: "-1 to all normal damage received.", pt: "-1 em todo dano normal recebido." },
  "Energy Drain": { en: "Steal 3 HP from enemy General.", pt: "Rouba 3 HP do General inimigo." },
  "Energy Genome": { en: "+1 HP at the start of each of your turns.", pt: "+1 HP no início de cada um dos seus turnos." },
  "Estranged Self": { en: "Remove all enemy junction abilities. You take +2 damage.", pt: "Remove todas as junctions inimigas. Você recebe +2 de dano." },
  "Filling Hollow": { en: "Each your turn: remove 1 random junction from both generals.", pt: "Cada turno seu: remove 1 junction aleatória de ambos os generais." },
  "Fire Fang": { en: "+1 AP immediately.", pt: "+1 AP imediatamente." },
  "First Strike": { en: "1 damage to both Generals at the start of each turn.", pt: "1 de dano em ambos os Generais no início de cada turno." },
  "First to Action": { en: "Deal 5 damage to enemy. Take 1 damage each subsequent turn.", pt: "Causa 5 de dano ao inimigo. Recebe 1 de dano em cada turno seguinte." },
  "Flame Fang": { en: "+2 AP immediately.", pt: "+2 AP imediatamente." },
  "Folset's Trial": { en: "Start of your turn: +1 AP, -1 HP.", pt: "Início do seu turno: +1 AP, -1 HP." },
  "Fused Consciousness": { en: "Set both Generals' AP and HP to the average of both.", pt: "Define AP e HP de ambos como a média dos dois." },
  "Gabi's Call": { en: "Nullify Snipe and Assault junction abilities of enemy.", pt: "Anula junctions Snipe e Assault do inimigo." },
  "Gathering of the Strong": { en: "Deal 1 damage to enemy each turn for 5 turns.", pt: "Causa 1 de dano ao inimigo por turno durante 5 turnos." },
  "Golden Spear": { en: "Deal 4 damage to enemy General immediately.", pt: "Causa 4 de dano ao General inimigo imediatamente." },
  "Grief of Comrade": { en: "+2 HP for each junction ability the enemy holds.", pt: "+2 HP para cada junction que o inimigo possui." },
  "Hammer of Undoing": { en: "Deal 5 damage to both Generals immediately.", pt: "Causa 5 de dano em ambos os Generais imediatamente." },
  "Harmonic Rhythm": { en: "+2 AP start of turn if first; +4 HP if second.", pt: "+2 AP início do turno se primeiro; +4 HP se segundo." },
  "Immortal Genome": { en: "+2 HP at the start of each of your turns.", pt: "+2 HP no início de cada um dos seus turnos." },
  "Ingenious Scheme": { en: "Reflect all damage back to enemy for 2 turns.", pt: "Reflete todo dano de volta ao inimigo por 2 turnos." },
  "Kaede's Guard": { en: "Nullify Snipe and Shield junction abilities of enemy.", pt: "Anula junctions Snipe e Shield do inimigo." },
  "Light of Annihilation": { en: "3 damage to both Generals every turn.", pt: "3 de dano em ambos os Generais todo turno." },
  "Long-awaited Return": { en: "Start of your turn: +1 AP, +2 HP.", pt: "Início do seu turno: +1 AP, +2 HP." },
  "Massacre Pulse": { en: "Each time you attack, gain +1 AP.", pt: "Cada vez que você atacar, ganha +1 AP." },
  "Meeting of Souls": { en: "Swap all junction abilities between both Generals.", pt: "Troca todas as junctions entre os dois Generais." },
  "Merciless Light": { en: "2 damage to both Generals at start of each turn.", pt: "2 de dano em ambos os Generais no início de cada turno." },
  "Mind's Eye": { en: "Evade one enemy attack (one turn only).", pt: "Esquiva de um ataque inimigo (apenas um turno)." },
  "Mirror of Revenge": { en: "Reflect all damage received back to enemy for 3 turns.", pt: "Reflete todo dano recebido ao inimigo por 3 turnos." },
  "Mobilize the Troops": { en: "After 5 turns, heal +1 HP per turn.", pt: "Após 5 turnos, cura +1 HP por turno." },
  "Momentary Glory": { en: "+3 AP / -3 enemy AP for 1 turn, then -1 AP / +1 enemy AP each turn after.", pt: "+3 AP / -3 AP inimigo por 1 turno, depois -1 AP / +1 AP inimigo por turno." },
  ...
  "Price of Insight": { en: "Replace this ability with a random new junction ability.", pt: "Substitui esta ability por uma junction aleatória." },
  "Promised Discretion": { en: "Cap damage either General receives at 3 per hit.", pt: "Limita o dano recebido a 3 por hit." },
  "Quick Lightning": { en: "Deal 3 damage to enemy General immediately.", pt: "Causa 3 de dano ao General inimigo imediatamente." },
  "Quickdance": { en: "-3 AP, but your General attacks even during enemy's turn.", pt: "-3 AP, mas seu General ataca mesmo no turno inimigo." },
  "Reckless Rewards": { en: "+2 AP. Each time you receive damage, take +1 extra.", pt: "+2 AP. Cada vez que receber dano, recebe +1 extra." },
  "Rendezvous": { en: "+10 HP at start of combat. At turn 8, take 10 damage.", pt: "+10 HP no início do combate. No turno 8, recebe 10 de dano." },
  "Shield Protection": { en: "Remove 1 Snipe-type junction from enemy.", pt: "Remove 1 junction tipo Snipe do inimigo." },
  "Shooting Squad": { en: "Nullify Assault and Shield junction abilities of enemy.", pt: "Anula junctions Assault e Shield do inimigo." },
  "Snipe Thunder": { en: "Remove 1 Assault-type junction from enemy.", pt: "Remove 1 junction tipo Assault do inimigo." },
  "Spirit Clothes": { en: "-1 to all damage received permanently.", pt: "-1 em todo dano recebido permanentemente." },
  "Suck it up": { en: "Once: if HP hits 0, restore to 5.", pt: "Uma vez: se HP chegar a 0, restaura para 5." },
  "Time Torrent": { en: "Skip enemy General's turn for 1 round.", pt: "Pula o turno do General inimigo por 1 rodada." },
  "Tragic Arrow": { en: "Deal 2 damage to enemy at the start of your turn.", pt: "Causa 2 de dano ao inimigo no início do seu turno." },
  "Trial by Fire": { en: "Cannot attack for 4 turns. After turn 4: +5 AP, +6 HP.", pt: "Não pode atacar por 4 turnos. Depois do turno 4: +5 AP, +6 HP." },
  "Twilight's Call": { en: "After 5 turns, reactivate all your junction abilities.", pt: "Após 5 turnos, reativa todas as suas junction abilities." },
  "Veil of Aura": { en: "-2 to all damage received permanently.", pt: "-2 em todo dano recebido permanentemente." },
  "Vengeful Arrow": { en: "Deal 1 damage to enemy at the start of your turn.", pt: "Causa 1 de dano ao inimigo no início do seu turno." },
  "Verboten Libation": { en: "+7 HP immediately.", pt: "+7 HP imediatamente." },
  "Vitality Medicine": { en: "+5 HP immediately.", pt: "+5 HP imediatamente." },
  "Warning Harmony": { en: "If enemy has 2+ junctions active: remove 1 random enemy junction.", pt: "Se inimigo tem 2+ junctions ativas: remove 1 junction inimiga aleatória." },
  "Whirlwind Assault": { en: "Remove 1 Shield-type junction from enemy.", pt: "Remove 1 junction tipo Shield do inimigo." },
  "Will of Similars": { en: "+3 AP/HP if same trinity as your unit. -3 if different.", pt: "+3 AP/HP se mesmo trinity. -3 se diferente." },
};
  ...
  function PhaseHeader({ back, hideBack }) {
    return (
      React.createElement('div', { style: {flexShrink:0, padding:"8px 14px 0", width:"100%"},}
        , React.createElement(ArenaStatsBar, null )
...
// ─── GAME MODE SCREEN ────────────────────────
// ─────────────────────────────────────────────
// PVP QUEUE — automatic matchmaking search
// ─────────────────────────────────────────────
function PvpQueueScreen({ onBack, onMatchFound }) {
  ...
  useEffect(() => {
    ...
    setStatus("waiting");
    setElapsed(0);
    socket.emit("queue:join", { nick: _optionalChain([activePlayer, 'optionalAccess', _71 => _71.nick]), deck });

    const onWaiting = () => setStatus("waiting");
    const onTimeout = () => setStatus("timeout");
    const onMatch = (data) => {
      setStatus("found");
      window.__CVS_PVP_MATCH__ = data;
      setTimeout(() => onMatchFound(), 600);
    };
    const onQueueError = (data) => { setStatus("error"); setError(_optionalChain([data, 'optionalAccess', _72 => _72.error]) || "Queue error."); };
  ...
  return (
    React.createElement('div', { style: S.root,}
      , React.createElement('div', { style: {...S.content, justifyContent:"center", alignItems:"center", display:"flex", flexDirection:"column", minHeight:"100vh"},}
        ...
        , status === "waiting" && (
          React.createElement(React.Fragment, null
            ...
            , React.createElement('div', { style: {fontFamily:"monospace", fontSize:15, fontWeight:700, color:C.cyan, letterSpacing:"0.06em", marginBottom:8},}
              , isPT ? "Procurando oponente..." : "Searching for opponent..."
            )
            , React.createElement('div', { style: {fontFamily:"monospace", fontSize:12, color:C.textMuted},}
              , elapsed, "s"
            )
          )
        )
        ...
        , status === "connecting" && (
          React.createElement('div', { style: {fontFamily:"monospace", fontSize:13, color:C.textMuted},}
            , isPT ? "Conectando ao servidor..." : "Connecting to server..."
          )
        )

        , status === "found" && (
          React.createElement('div', { style: {fontFamily:"monospace", fontSize:15, fontWeight:700, color:"#44ee88"},}, "⚡ "
             , isPT ? "Oponente encontrado!" : "Opponent found!"
          )
        )

        , status === "timeout" && (
          React.createElement(React.Fragment, null
            , React.createElement('div', { style: {fontFamily:"monospace", fontSize:14, color:C.accent, marginBottom:16, textAlign:"center"},}
              , isPT ? "Nenhum oponente encontrado." : "No opponent found."
            )
            , React.createElement('button', { onClick: onBack, style: {
        ...
        , status === "waiting" && (
          React.createElement('button', { onClick: cancelSearch, style: {
            marginTop:32, padding:"10px 24px", borderRadius:8, cursor:"pointer",
            background:"rgba(255,40,60,0.06)", border:"1px solid rgba(255,40,60,0.25)",
            color:"#ff6677", fontFamily:"monospace", fontSize:12, fontWeight:700,
...
// ─────────────────────────────────────────────
// PVP ARENA — mirrored layout placeholder.
// You are always rendered blue/bottom; opponent always red/top,
// regardless of internal A/B side bookkeeping on the server.
// ─────────────────────────────────────────────
// ─────────────────────────────────────────────
// PVP TRINITY TYPES — shared across PvP phases
// ─────────────────────────────────────────────
const PVP_TYPES = [
  { key:"Assault", label:"⚔ Assault", beats:"Shield",  color:"#ff4466", bg:"rgba(255,40,60,0.12)",  border:"rgba(255,40,60,0.5)" },
  { key:"Shield",  label:"🛡 Shield",  beats:"Snipe",   color:"#3399ff", bg:"rgba(40,100,255,0.12)", border:"rgba(40,100,255,0.5)" },
  { key:"Snipe",   label:"🦅 Snipe",   beats:"Assault", color:"#44ee88", bg:"rgba(68,238,136,0.12)", border:"rgba(68,238,136,0.5)" },
];

// ─────────────────────────────────────────────
// PVP ARENA — mirrored layout, server-driven phases.
// You are always rendered blue/bottom; opponent always red/top,
// regardless of internal A/B side bookkeeping on the server.
// ─────────────────────────────────────────────
function PvpArenaPlaceholder({ onBack }) {
  const { settings } = useSettings();
  const isPT = settings.language === "pt";
  const { socket } = usePvp();
  const { activePlayer } = useNick();

  const match = window.__CVS_PVP_MATCH__ || null;
  const mySide = _optionalChain([match, 'optionalAccess', _73 => _73.you]); // 'A' | 'B'

  const [phase, setPhase] = useState("trinity");
  const [ended, setEnded] = useState(null); // { type, text }

  // Trinity-specific local state
  const [myPick, setMyPick] = useState(null);
  const [trinityWaiting, setTrinityWaiting] = useState(false);
  const [trinityResult, setTrinityResult] = useState(null); // { pickA, pickB, result }
  const [trinityDraw, setTrinityDraw] = useState(false);

  // Reveal
  const [revealAcked, setRevealAcked] = useState(false);

  // Ban / Cut
  const [myBanPick, setMyBanPick] = useState(null);
  const [banWaiting, setBanWaiting] = useState(false);
  const [banResult, setBanResult] = useState(null);
  const [myCutPicks, setMyCutPicks] = useState([]);
  const [cutWaiting, setCutWaiting] = useState(false);
  const [cutResult, setCutResult] = useState(null);
  const [confirmWaiting, setConfirmWaiting] = useState(false);

  // Clash
  const [clashLayout, setClashLayout] = useState([null, null, null]);
  const [clashWaiting, setClashWaiting] = useState(false);
  const [clashResult, setClashResult] = useState(null);
  const [clashStep, setClashStep] = useState(0);       // 0,1,2 = position index, 3 = done
  const [clashStepResults, setClashStepResults] = useState([]); // [{position, unitAId, unitBId, winner}]
  const [clashMyAck, setClashMyAck] = useState(false);
  const [clashOppAck, setClashOppAck] = useState(false);
  ...
  useEffect(() => {
    ...
    const onClashAdvanceAcked = (data) => {
      if (data.side === mySide) setClashMyAck(true);
      else setClashOppAck(true);
    };
    const onClashStepResult = (data) => {
      ...
      const unitA = _optionalChain([myDeckS, 'optionalAccess', _91 => _91.units, 'optionalAccess', _92 => _92.find, 'call', _93 => _93(u => u.id === data.unitAId)]) || _optionalChain([oppDeckS, 'optionalAccess', _94 => _94.units, 'optionalAccess', _95 => _95.find, 'call', _96 => _96(u => u.id === data.unitAId)]);
      const unitB = _optionalChain([myDeckS, 'optionalAccess', _97 => _97.units, 'optionalAccess', _98 => _98.find, 'call', _99 => _99(u => u.id === data.unitBId)]) || _optionalChain([oppDeckS, 'optionalAccess', _100 => _100.units, 'optionalAccess', _101 => _101.find, 'call', _102 => _102(u => u.id === data.unitBId)]);
      if (data.winner === "fizzle") {
        addLog(isPT ? `⚡ ${data.position}: FIZZLE — ambos destruídos` : `⚡ ${data.position}: FIZZLE — both destroyed`);
      } else if (unitA && unitB) {
        const winnerUnit = data.winner === "A" ? unitA : unitB;
        const loserUnit  = data.winner === "A" ? unitB : unitA;
        addLog(isPT ? `✓ ${data.position}: ${winnerUnit.name} derrota ${loserUnit.name}` : `✓ ${data.position}: ${winnerUnit.name} defeats ${loserUnit.name}`);
      }
    };
    const onClashResult   = (data) => {
      setClashResult(data); setClashWaiting(false); setBattle(data.battle);
      addLog(isPT ? "⚔ Clash resolvido — Batalha começando!" : "⚔ Clash resolved — Battle starting!");
    };
    ...
    socket.on("phase:trinityDraw",   onTrinityDraw);
    socket.on("phase:advance",       onAdvance);
    socket.on("phase:banResult",     onBanResult);
    socket.on("phase:cutResult",     onCutResult);
    socket.on("phase:clashReady",        onClashReady);
    socket.on("phase:clashAdvanceAcked", onClashAdvanceAcked);
    socket.on("phase:clashStepResult",   onClashStepResult);
    socket.on("phase:clashResult",   onClashResult);
    socket.on("battle:turnResult",   onBattleTurn);
    socket.on("match:opponentLeft",  onOpponentLeft);
    socket.on("match:surrendered",   onSurrendered);

    return () => {
      socket.off("phase:trinityResult", onTrinityResult);
      socket.off("phase:trinityDraw",   onTrinityDraw);
      socket.off("phase:advance",       onAdvance);
      socket.off("phase:banResult",     onBanResult);
      socket.off("phase:cutResult",     onCutResult);
      socket.off("phase:clashReady",        onClashReady);
      socket.off("phase:clashAdvanceAcked", onClashAdvanceAcked);
      socket.off("phase:clashStepResult",   onClashStepResult);
      socket.off("phase:clashResult",   onClashResult);
      socket.off("battle:turnResult",   onBattleTurn);
      socket.off("match:opponentLeft",  onOpponentLeft);
      socket.off("match:surrendered",   onSurrendered);
    };
  }, [socket, match, mySide, isPT]);

  if (!match) {
    return (
      React.createElement('div', { style: S.root,}
        , React.createElement('div', { style: {...S.content, justifyContent:"center", alignItems:"center", display:"flex", minHeight:"100vh"},}
          , React.createElement('div', { style: {fontFamily:"monospace", color:C.textMuted, fontSize:13},}
            , isPT ? "Nenhuma partida ativa." : "No active match."
          )
        )
      )
    );
  ...
  const send = (type, payload) => socket && socket.emit("phase:action", { roomId: match.roomId, type, payload });
  ...
  // ── Header: mirrored opponent/you banner, shown above every phase ──────
  const PVP_PHASE_STEPS  = ["trinity","reveal","ban","cut","confirm","clash","battle"];
  const PVP_PHASE_LABELS = {
    trinity: isPT ? "Trinity"  : "Trinity",
    reveal:  isPT ? "Revelar"  : "Reveal",
    ban:     isPT ? "Ban"      : "Ban",
    cut:     isPT ? "Corte"    : "Cut",
    confirm: isPT ? "Pronto"   : "Ready",
    clash:   isPT ? "Clash"    : "Clash",
    battle:  isPT ? "Batalha"  : "Battle",
  };

  function PvpPhaseHeader() {
    const myGen  = _optionalChain([resolveDeck, 'call', _103 => _103(), 'optionalAccess', _104 => _104.general]);
    const oppGen = _optionalChain([match, 'optionalAccess', _105 => _105.opponentDeck, 'optionalAccess', _106 => _106.general]);
    ...
    return (
      React.createElement('div', { style: {flexShrink:0, width:"100%", marginBottom:10},}
        ...
        , React.createElement('div', { style: {display:"flex", alignItems:"center", gap:6, marginBottom:8},}
          ...
          , React.createElement('div', { style: {flex:1, display:"flex", gap:3, justifyContent:"center", alignItems:"center"},}
            , PVP_PHASE_STEPS.map((p, i) => {
              const active = phase === p;
              const done   = PVP_PHASE_STEPS.indexOf(phase) > i;
              return (
                React.createElement('div', { key: p, style: {display:"flex", alignItems:"center", gap:2},}
                  , React.createElement('div', { style: {
                    padding:"2px 7px", borderRadius:20, fontFamily:"monospace",
                    ...
                    border:`1px solid ${active ? "rgba(0,245,255,0.5)" : done ? "rgba(68,238,136,0.3)" : "rgba(255,255,255,0.07)"}`,
                    color: active ? C.cyan : done ? "#44ee88" : C.textMuted,
                  },}, done ? "✓" : PVP_PHASE_LABELS[p])
                  , i < PVP_PHASE_STEPS.length - 1 && React.createElement('span', { style: {color:"rgba(255,255,255,0.12)", fontSize:7},}, "›")
                )
              );
            })
          )
        ...
        /* Mirrored generals bar — you always left/cyan, opponent always right/red */
        , myGen && oppGen ? (
          React.createElement('div', { style: {display:"flex", gap:8, alignItems:"center",
            ...
            , React.createElement('div', { style: {display:"flex", alignItems:"center", gap:8, flex:1, minWidth:0},}
              , React.createElement('div', { style: {width:42, height:56, flexShrink:0, borderRadius:6, overflow:"hidden",
                border:`2px solid ${TYPE_COLOR[myGen.type]||"#aaa"}`,
                boxShadow:`0 0 8px ${TYPE_GLOW[myGen.type]||"transparent"}`},}
                , React.createElement('img', { src: IMGS[(myGen.img||"").replace(".png","")] || "", alt: "",
                  style: {width:"100%", height:"100%", objectFit:"cover", display:"block"},})
              )
              , React.createElement('div', { style: {minWidth:0},}
                , React.createElement('div', { style: {fontSize:9, color:C.cyan, fontFamily:"monospace", fontWeight:700, letterSpacing:"0.06em"},}, myNick)
                , React.createElement('div', { style: {fontSize:11, fontWeight:700, color:C.textPrimary, fontFamily:"monospace",
                  whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis", maxWidth:90, marginBottom:2},}, myGen.name)
                , React.createElement('div', { style: {display:"flex", gap:6},}
                  , React.createElement('span', { style: {fontSize:10, color:"#44ee88", fontFamily:"monospace", fontWeight:700},}, "HP " , battle ? Math.max(0,_nullishCoalesce(_optionalChain([(mySide==="A"?battle.stateA:battle.stateB), 'optionalAccess', _107 => _107.hp]), () => ( myGen.hp))) : myGen.hp)
                  , React.createElement('span', { style: {fontSize:10, color:"#ff8844", fontFamily:"monospace", fontWeight:700},}, "AP " , battle ? _nullishCoalesce(_optionalChain([(mySide==="A"?battle.stateA:battle.stateB), 'optionalAccess', _108 => _108.ap]), () => ( myGen.ap)) : myGen.ap)
                )
            ...
            , React.createElement('div', { style: {display:"flex", alignItems:"center", gap:8, flex:1, minWidth:0, justifyContent:"flex-end"},}
              , React.createElement('div', { style: {minWidth:0, textAlign:"right"},}
                , React.createElement('div', { style: {fontSize:9, color:"#ff4466", fontFamily:"monospace", fontWeight:700, letterSpacing:"0.06em"},}, oppNick)
                , React.createElement('div', { style: {fontSize:11, fontWeight:700, color:C.textPrimary, fontFamily:"monospace",
                  whiteSpace:"nowrap", overflow:"hidden", textOverflow:"ellipsis", maxWidth:90, marginBottom:2},}, oppGen.name)
                , React.createElement('div', { style: {display:"flex", gap:6, justifyContent:"flex-end"},}
                  , React.createElement('span', { style: {fontSize:10, color:"#44ee88", fontFamily:"monospace", fontWeight:700},}, "HP " , battle ? Math.max(0,_nullishCoalesce(_optionalChain([(mySide==="A"?battle.stateB:battle.stateA), 'optionalAccess', _109 => _109.hp]), () => ( oppGen.hp))) : oppGen.hp)
                  , React.createElement('span', { style: {fontSize:10, color:"#ff8844", fontFamily:"monospace", fontWeight:700},}, "AP " , battle ? _nullishCoalesce(_optionalChain([(mySide==="A"?battle.stateB:battle.stateA), 'optionalAccess', _110 => _110.ap]), () => ( oppGen.ap)) : oppGen.ap)
                )
                , React.createElement('div', { style: {fontSize:9, color:"#cc88ff", fontFamily:"monospace"},}, oppGen.type, " · Chr "   , oppGen.charisma)
              )
              , React.createElement('div', { style: {width:42, height:56, flexShrink:0, borderRadius:6, overflow:"hidden",
                border:`2px solid ${TYPE_COLOR[oppGen.type]||"#aaa"}`,
                boxShadow:`0 0 8px ${TYPE_GLOW[oppGen.type]||"transparent"}`},}
                , React.createElement('img', { src: IMGS[(oppGen.img||"").replace(".png","")] || "", alt: "",
                  style: {width:"100%", height:"100%", objectFit:"cover", display:"block"},})
              )
            )
          )
        ) : (
          React.createElement('div', { style: {display:"flex", gap:8, alignItems:"center", justifyContent:"space-between",
            background:"rgba(0,10,40,0.6)", border:`1px solid ${C.border}`,
            borderRadius:9, padding:"10px 14px", width:"100%"},}
            , React.createElement('span', { style: {fontFamily:"monospace", fontSize:12, fontWeight:700, color:C.cyan},}, myNick)
            , React.createElement('span', { style: {fontFamily:"monospace", fontSize:11, color:C.textMuted},}, "VS")
            , React.createElement('span', { style: {fontFamily:"monospace", fontSize:12, fontWeight:700, color:"#ff4466"},}, oppNick)
          )
        )
      )
    );
  ...
  if (ended) {
    const color = ended.type === "win" ? "#44ee88" : ended.type === "loss" ? "#ff4466" : "#ffcc00";
    return (
      React.createElement('div', { style: S.root,}
        , React.createElement('div', { style: {...S.content, justifyContent:"center", alignItems:"center", display:"flex", flexDirection:"column", minHeight:"100vh", gap:18},}
          , React.createElement('div', { style: {fontFamily:"monospace", fontSize:20, fontWeight:800, color},}, ended.text)
          , React.createElement('button', { onClick: onBack, style: {
            padding:"11px 28px", borderRadius:9, cursor:"pointer",
            background:"rgba(0,245,255,0.08)", border:"1px solid rgba(0,245,255,0.3)",
            color:C.cyan, fontFamily:"monospace", fontSize:13, fontWeight:700,
          },}, isPT ? "Voltar ao Menu" : "Back to Menu")
        )
      )
    );
  }
  ...
  if (phase === "trinity") {
    const pickType = (key) => {
      setMyPick(key);
      setTrinityWaiting(true);
      send("trinity_pick", key);
    };
    return (
      React.createElement('div', { style: S.root,}
        , React.createElement('div', { style: {...S.content, paddingBottom:"2rem"},}
          , React.createElement(PvpPhaseHeader, null )
          , React.createElement('h1', { style: {...S.screenTitle, fontSize:16, marginBottom:6},}, "⚡ " , isPT ? "Duelo Trinity" : "Trinity Duel")
          , React.createElement('div', { style: {fontFamily:"monospace", fontSize:11, color:C.textMuted, textAlign:"center", marginBottom:16},}
            , isPT ? "Vencedor vai primeiro na Batalha dos Generais" : "Winner goes first in the General Battle"
          )

          , trinityDraw && (
            React.createElement('div', { style: {textAlign:"center", fontFamily:"monospace", fontSize:13, color:"#ffcc00", marginBottom:14, fontWeight:700},}, "⚡ "
               , isPT ? "EMPATE! Escolha novamente." : "DRAW! Choose again."
            )
          )

          , React.createElement('div', { style: {display:"flex", flexDirection:"column", gap:10, maxWidth:320, margin:"0 auto"},}
            , PVP_TYPES.map(t => (
              React.createElement('button', { key: t.key, onClick: () => !trinityWaiting && pickType(t.key), disabled: trinityWaiting, style: {
                padding:"14px 0", borderRadius:10, cursor: trinityWaiting ? "not-allowed" : "pointer",
                background: myPick === t.key ? t.bg : "rgba(255,255,255,0.03)",
                border: `1px solid ${myPick === t.key ? t.border : "rgba(255,255,255,0.1)"}`,
                color: t.color, fontFamily:"monospace", fontSize:15, fontWeight:700,
                opacity: trinityWaiting && myPick !== t.key ? 0.4 : 1,
              },}, t.label)
            ))
          )

          , trinityWaiting && (
            React.createElement('div', { style: {textAlign:"center", marginTop:16, fontFamily:"monospace", fontSize:11, color:C.textMuted},}
  ...
  if (phase === "reveal") {
    ...
    const oppDeck = _optionalChain([match, 'optionalAccess', _111 => _111.opponentDeck]);
    const myUnitsR  = _optionalChain([myDeck, 'optionalAccess', _112 => _112.units]) || [];
    const oppUnitsR = _optionalChain([oppDeck, 'optionalAccess', _113 => _113.units]) || [];

    function PoolColumn({ units, label, color, glow, bg, borderTint }) {
      return (
        React.createElement('div', { style: {flex:1},}
          , React.createElement('div', { style: {fontSize:12, color, fontFamily:"monospace", fontWeight:700,
            letterSpacing:"0.06em", textTransform:"uppercase", marginBottom:8,
            textAlign:"center", textShadow:`0 0 8px ${glow}`},}, label)
          , React.createElement('div', { style: {display:"flex", flexDirection:"column", gap:7},}
            , units.map(u => {
              const tc = TYPE_COLOR[u.type]||"#aaa";
              return (
    ...
    return (
      React.createElement('div', { style: {width:"100%", height:"100vh", display:"flex", flexDirection:"column"},}
        , React.createElement('div', { style: {flexShrink:0, padding:"10px 14px 0", width:"100%", boxSizing:"border-box"},}
          , React.createElement(PvpPhaseHeader, null )
        )
        /* Scrollable content — pools side by side, exactly like the vs-AI arena */
        , React.createElement('div', { style: {flex:1, overflowY:"auto", padding:"0 14px 10px", width:"100%", boxSizing:"border-box"},}
          , React.createElement('div', { style: {display:"flex", gap:8},}
            , React.createElement(PoolColumn, {
              units: myUnitsR,
              label: isPT ? `${myNick} (Unidades)` : `${myNick} (Units)`,
              color: C.cyan, glow: "rgba(0,245,255,0.4)", bg: "rgba(0,10,50,0.55)",}
            )
            , React.createElement(PoolColumn, {
              units: oppUnitsR,
              label: isPT ? `${oppNick} (Unidades)` : `${oppNick} (Units)`,
        ...
        , React.createElement('div', { style: {flexShrink:0, padding:"10px 14px", background:"rgba(2,4,38,0.95)",
          ...
          , React.createElement('button', { onClick: ack, disabled: revealAcked, style: {
            width:"100%", padding:"13px 0",
            background: revealAcked ? "rgba(0,245,255,0.04)" : "rgba(0,245,255,0.12)",
            border:"1px solid rgba(0,245,255,0.5)",
            borderRadius:9, cursor: revealAcked ? "not-allowed" : "pointer", color:C.cyan,
            fontFamily:"monospace", fontSize:14, fontWeight:700, letterSpacing:"0.08em",
            textShadow:"0 0 10px rgba(0,245,255,0.5)",
            boxShadow:"0 0 16px rgba(0,245,255,0.07)",
            opacity: revealAcked ? 0.5 : 1,
          },}, revealAcked ? (isPT ? "Aguardando oponente..." : "Waiting for opponent...") : (isPT ? "⚔ Fase de Ban →" : "⚔ Ban Phase →"))
        )
      )
    );
  }
        ...
        , React.createElement('div', { onClick: e => e.stopPropagation(), style: {
          ...
          , pvpInfoCard.junction && (
            React.createElement('div', { style: {background:"rgba(0,245,255,0.05)", border:"1px solid rgba(0,245,255,0.15)",
              ...
              , React.createElement('div', { style: {fontFamily:"monospace", fontSize:11, color:"rgba(180,220,255,0.85)", lineHeight:1.55},}
                , (_optionalChain([JUNCTION_DESC, 'access', _114 => _114[pvpInfoCard.junction], 'optionalAccess', _115 => _115[isPT?"pt":"en"]])) || "— No description available."
              )
            )
          )
  ...
  if (phase === "ban") {
    const oppDeck = _optionalChain([match, 'optionalAccess', _116 => _116.opponentDeck]);
    const oppUnits = _optionalChain([oppDeck, 'optionalAccess', _117 => _117.units]) || [];

    const confirmBan = () => {
      if (!myBanPick) return;
      setBanWaiting(true);
      send("ban", { unitId: myBanPick });
    };
    ...
    return (
      React.createElement('div', { style: S.root,}
        , React.createElement('div', { style: {...S.content, paddingBottom:"2rem"},}
          ...
          , React.createElement('button', { onClick: confirmBan, disabled: !myBanPick || banWaiting, style: {
            width:"100%", padding:"12px 0", borderRadius:9, cursor: (!myBanPick || banWaiting) ? "not-allowed" : "pointer",
            background:"rgba(255,40,60,0.08)", border:"1px solid rgba(255,40,60,0.3)",
            color:"#ff6677", fontFamily:"monospace", fontSize:13, fontWeight:700,
  ...
  if (phase === "cut") {
    const myDeck = resolveDeck();
    const myBannedId = _optionalChain([banResult, 'optionalAccess', _118 => _118.bannedFromA]) === mySide ? null : (mySide === "A" ? _optionalChain([banResult, 'optionalAccess', _119 => _119.bannedFromA]) : _optionalChain([banResult, 'optionalAccess', _120 => _120.bannedFromB]));
    const remaining = (_optionalChain([myDeck, 'optionalAccess', _121 => _121.units]) || []).filter(u => u.id !== myBannedId);
    ...
    const confirmCut = () => {
      if (myCutPicks.length !== 3) return;
      setCutWaiting(true);
      send("cut", { keptUnitIds: myCutPicks });
    };
    ...
    return (
      React.createElement('div', { style: S.root,}
        , React.createElement('div', { style: {...S.content, paddingBottom:"2rem"},}
          , React.createElement(PvpPhaseHeader, null )
          , React.createElement('h1', { style: {...S.screenTitle, fontSize:16, marginBottom:6},}, "✂ " , isPT ? "Fase de Corte" : "Cut Phase")
          , React.createElement('div', { style: {fontFamily:"monospace", fontSize:11, color:C.textMuted, textAlign:"center", marginBottom:14},}
            , isPT ? `Selecione 3 unidades para manter (${myCutPicks.length}/3)` : `Select 3 units to keep (${myCutPicks.length}/3)`
          )

          , React.createElement('div', { style: {display:"grid", gridTemplateColumns:"repeat(4, 1fr)", gap:8, marginBottom:16},}
            , remaining.map(u => {
              const isSel = myCutPicks.includes(u.id);
              return (
                React.createElement('div', { key: u.id, onClick: () => toggleCut(u.id), style: {
                  position:"relative", aspectRatio:"3/4", borderRadius:8, overflow:"hidden", cursor: cutWaiting ? "default" : "pointer",
                  border: isSel ? `2px solid ${TYPE_COLOR[u.type]||"#aaa"}` : "1.5px solid rgba(255,255,255,0.12)",
          ...
          , React.createElement('button', { onClick: confirmCut, disabled: myCutPicks.length !== 3 || cutWaiting, style: {
            width:"100%", padding:"12px 0", borderRadius:9, cursor: (myCutPicks.length !== 3 || cutWaiting) ? "not-allowed" : "pointer",
            background:"rgba(0,245,255,0.08)", border:"1px solid rgba(0,245,255,0.3)",
            color:C.cyan, fontFamily:"monospace", fontSize:13, fontWeight:700,
  ...
  if (phase === "confirm") {
    ...
    const myKept = (_optionalChain([myDeck, 'optionalAccess', _122 => _122.units]) || []).filter(u => myKeptIds.includes(u.id));
    ...
    return (
      React.createElement('div', { style: S.root,}
        , React.createElement('div', { style: {...S.content, paddingBottom:"2rem"},}
          , React.createElement(PvpPhaseHeader, null )
          , React.createElement('h1', { style: {...S.screenTitle, fontSize:16, marginBottom:10},}, "✓ " , isPT ? "Confirmação" : "Confirm")
          , React.createElement('div', { style: {fontFamily:"monospace", fontSize:11, color:C.textMuted, textAlign:"center", marginBottom:14},}
            , isPT ? "Sua formação final:" : "Your final line-up:"
          )
          ...
          , React.createElement('button', { onClick: confirmReady, disabled: confirmWaiting, style: {
            width:"100%", padding:"12px 0", borderRadius:9, cursor: confirmWaiting ? "not-allowed" : "pointer",
            background:"rgba(0,245,255,0.08)", border:"1px solid rgba(0,245,255,0.3)",
            color:C.cyan, fontFamily:"monospace", fontSize:13, fontWeight:700,
  ...
  if (phase === "clash") {
    const myDeck  = resolveDeck();
    const oppDeck = _optionalChain([match, 'optionalAccess', _123 => _123.opponentDeck]);
    const myKeptIds = cutResult ? (mySide === "A" ? cutResult.cutA : cutResult.cutB) : myCutPicks;
    const myKept = (_optionalChain([myDeck, 'optionalAccess', _124 => _124.units]) || []).filter(u => myKeptIds.includes(u.id));

    // POS_LABELS index 0 = Right, 1 = Center, 2 = Left — matches the vs-AI
    // arena and the backend's CLASH_POSITIONS order exactly.
    const POS_LABELS = [isPT ? "DIREITA" : "RIGHT", isPT ? "CENTRO" : "CENTER", isPT ? "ESQUERDA" : "LEFT"];

    const placeAt = (slotIdx, unitId) => {
      if (clashWaiting) return;
      setClashLayout(prev => {
        const next = [...prev];
        for (let i = 0; i < 3; i++) if (next[i] === unitId) next[i] = null;
        next[slotIdx] = unitId;
        return next;
      });
    };
    ...
    const confirmClash = () => {
      if (clashLayout.some(s => s === null)) return;
      setClashWaiting(true);
      send("clash_layout", { layout: clashLayout });
    };

    const advanceStep = () => {
      if (clashMyAck) return;
      setClashMyAck(true);
      socket.emit("phase:action", { roomId: match.roomId, type: "clash_advance", payload: true });
    };

    // ── Step 1: layout selection (before the server has acked clash_layout) ──
    if (!clashWaiting && clashStepResults.length === 0 && clashStep === 0 && !battle) {
      return (
        React.createElement('div', { style: S.root,}
          , React.createElement('div', { style: {...S.content, paddingBottom:"2rem"},}
            , React.createElement(PvpPhaseHeader, null )
            , React.createElement('h1', { style: {...S.screenTitle, fontSize:16, marginBottom:6},}, "⚔ " , isPT ? "Clash" : "Clash")
            , React.createElement('div', { style: {fontFamily:"monospace", fontSize:11, color:C.textMuted, textAlign:"center", marginBottom:14},}
              , isPT ? "Posicione suas unidades nas 3 posições" : "Arrange your units into the 3 positions"
            )

            , React.createElement('div', { style: {display:"flex", gap:8, justifyContent:"center", marginBottom:16},}
              , [0,1,2].map(slotIdx => {
                const unitId = clashLayout[slotIdx];
                const unit = myKept.find(u => u.id === unitId);
                return (
                  React.createElement('div', { key: slotIdx, style: {width:80, textAlign:"center"},}
                    , React.createElement('div', { style: {fontFamily:"monospace", fontSize:8, color:C.textMuted, marginBottom:3},}, POS_LABELS[slotIdx])
                    , React.createElement('div', { style: {aspectRatio:"3/4", borderRadius:8, overflow:"hidden",
                      border: unit ? `2px solid ${TYPE_COLOR[unit.type]||"#aaa"}` : "1.5px dashed rgba(255,255,255,0.2)",
                      background:"rgba(255,255,255,0.03)"},}
                      , unit && React.createElement('img', { src: IMGS[(unit.img||"").replace(".png","")]||"", alt: unit.name, style: {width:"100%", height:"100%", objectFit:"cover"},})
                    )
                  )
                );
              })
            ...
            , React.createElement('div', { style: {fontFamily:"monospace", fontSize:9, color:C.textMuted, textAlign:"center", marginBottom:6},}
              , isPT ? "Toque numa unidade, depois num slot" : "Tap a unit, then tap a slot"
            )
            , React.createElement('div', { style: {display:"flex", gap:8, justifyContent:"center", marginBottom:18},}
              , myKept.map(u => {
                const placedSlot = clashLayout.indexOf(u.id);
                return (
                  React.createElement('div', { key: u.id, onClick: () => {
                    if (clashWaiting) return;
                    const emptySlot = clashLayout.indexOf(null);
                    if (placedSlot >= 0) {
                      setClashLayout(prev => { const n=[...prev]; n[placedSlot]=null; return n; });
                    } else if (emptySlot >= 0) {
                      placeAt(emptySlot, u.id);
                    }
                  }, style: {
                    position:"relative", width:56, aspectRatio:"3/4", borderRadius:6, overflow:"hidden", cursor: clashWaiting ? "default" : "pointer",
                    border: placedSlot >= 0 ? `2px solid ${TYPE_COLOR[u.type]||"#aaa"}` : "1.5px solid rgba(255,255,255,0.15)",
            ...
            , React.createElement('button', { onClick: confirmClash, disabled: clashLayout.some(s => s === null), style: {
              width:"100%", padding:"12px 0", borderRadius:9,
              cursor: clashLayout.some(s => s === null) ? "not-allowed" : "pointer",
              background:"rgba(0,245,255,0.08)", border:"1px solid rgba(0,245,255,0.3)",
              color:C.cyan, fontFamily:"monospace", fontSize:13, fontWeight:700,
              opacity: clashLayout.some(s => s === null) ? 0.5 : 1,
            },}, isPT ? "Confirmar Posições" : "Confirm Positions")
            , React.createElement(ArenaLogPanel, null )
          )
          , React.createElement(PvpCardInfoPopup, null )
        )
    ...
    // ── Step 2: waiting for opponent's layout submission ──────────────────
    if (clashWaiting && clashStepResults.length === 0 && !battle) {
      return (
        React.createElement('div', { style: S.root,}
          , React.createElement('div', { style: {...S.content, justifyContent:"center", alignItems:"center", display:"flex", flexDirection:"column", minHeight:"100vh"},}
            , React.createElement(PvpPhaseHeader, null )
            , React.createElement('div', { style: {fontFamily:"monospace", fontSize:12, color:C.textMuted, marginTop:20},}
              , isPT ? "Aguardando posições do oponente..." : "Waiting for opponent's positions..."
            )
            , React.createElement(ArenaLogPanel, null )
          )
        )
    ...
    // ── Step 3: one-position-at-a-time reveal, mirroring the vs-AI flow ───
    const myLayoutUnits  = clashLayout.map(id => myKept.find(u => u.id === id));
    const oppKeptIdsAll  = mySide === "A" ? _optionalChain([cutResult, 'optionalAccess', _125 => _125.cutB]) : _optionalChain([cutResult, 'optionalAccess', _126 => _126.cutA]);
    const oppUnitsKept   = (_optionalChain([oppDeck, 'optionalAccess', _127 => _127.units]) || []).filter(u => _optionalChain([oppKeptIdsAll, 'optionalAccess', _128 => _128.includes, 'call', _129 => _129(u.id)]));

    const currentPos    = clashStep < 3 ? POS_LABELS[clashStep] : null;

    function ResultBadge({ winner }) {
      if (winner === "fizzle") return (
        React.createElement('div', { style: {padding:"4px 10px", borderRadius:20, fontSize:11, fontWeight:700,
          background:"rgba(150,100,0,0.2)", border:"1px solid rgba(255,200,0,0.4)",
          color:"#ffcc00", fontFamily:"monospace"},}, "⚡ FIZZLE" )
      );
      const iWon = winner === mySide;
      return (
        React.createElement('div', { style: {padding:"4px 10px", borderRadius:20, fontSize:11, fontWeight:700,
          background: iWon ? "rgba(0,245,100,0.1)" : "rgba(255,40,60,0.1)",
          border: `1px solid ${iWon ? "rgba(0,245,100,0.4)" : "rgba(255,40,60,0.4)"}`,
          color: iWon ? "#44ee88" : "#ff6677", fontFamily:"monospace"},}
          , iWon ? (isPT ? "✓ VOCÊ VENCE" : "✓ YOU WIN") : (isPT ? "✕ OPONENTE VENCE" : "✕ OPPONENT WINS")
        )
      );
    }
    ...
    return (
      React.createElement('div', { style: S.root,}
        , React.createElement('div', { style: {...S.content, paddingBottom:"2rem"},}
          ...
          /* Already-resolved positions, stacked above the current one */
          , clashStepResults.map((r, i) => {
            const myUnit  = myLayoutUnits[i];
            const oppUnit = oppUnitsKept[i];
            return (
              React.createElement('div', { key: i, style: {display:"flex", alignItems:"center", justifyContent:"space-between",
                gap:8, padding:"6px 10px", marginBottom:6, borderRadius:7,
                background:"rgba(255,255,255,0.03)", border:`1px solid ${C.border}`},}
                , React.createElement('span', { style: {fontFamily:"monospace", fontSize:10, color:C.textSub, width:54},}, r.position)
                , React.createElement('span', { style: {fontFamily:"monospace", fontSize:10, color:C.textMuted, flex:1, textAlign:"center"},}
                  , _optionalChain([myUnit, 'optionalAccess', _130 => _130.name]), " vs "  , _optionalChain([oppUnit, 'optionalAccess', _131 => _131.name])
                )
                , React.createElement(ResultBadge, { winner: r.winner,} )
              )
            );
          })

          /* Current position being revealed */
          , clashStep < 3 && (
            React.createElement('div', { style: {marginTop:10},}
              , React.createElement('div', { style: {textAlign:"center", fontFamily:"monospace", fontSize:11, color:C.accent, fontWeight:700, marginBottom:10, letterSpacing:"0.1em"},}
                , isPT ? `POSIÇÃO: ${currentPos}` : `POSITION: ${currentPos}`
              )
              , React.createElement('div', { style: {display:"flex", gap:10, justifyContent:"center", alignItems:"center", marginBottom:16},}
                , React.createElement('div', { style: {textAlign:"center"},}
                  , React.createElement('div', { style: {fontSize:9, color:C.cyan, fontFamily:"monospace", marginBottom:4},}, myNick)
                  , React.createElement('div', { style: {width:70, aspectRatio:"3/4", borderRadius:8, overflow:"hidden",
                    border:`2px solid ${TYPE_COLOR[_optionalChain([myLayoutUnits, 'access', _132 => _132[clashStep], 'optionalAccess', _133 => _133.type])]||"#aaa"}`},}
                    , myLayoutUnits[clashStep] && React.createElement('img', { src: IMGS[(myLayoutUnits[clashStep].img||"").replace(".png","")]||"", alt: "",
                      style: {width:"100%", height:"100%", objectFit:"cover"},})
                  )
                  , React.createElement('div', { style: {fontSize:9, fontFamily:"monospace", color:"#fff", marginTop:3},}, _optionalChain([myLayoutUnits, 'access', _134 => _134[clashStep], 'optionalAccess', _135 => _135.name]))
                )
                , React.createElement('div', { style: {fontSize:18, fontWeight:900, color:"#ff2244"},}, "VS")
                , React.createElement('div', { style: {textAlign:"center"},}
                  , React.createElement('div', { style: {fontSize:9, color:"#ff4466", fontFamily:"monospace", marginBottom:4},}, oppNick)
                  , React.createElement('div', { style: {width:70, aspectRatio:"3/4", borderRadius:8, overflow:"hidden",
                    border:`2px solid ${TYPE_COLOR[_optionalChain([oppUnitsKept, 'access', _136 => _136[clashStep], 'optionalAccess', _137 => _137.type])]||"#aaa"}`},}
                    , oppUnitsKept[clashStep] && React.createElement('img', { src: IMGS[(oppUnitsKept[clashStep].img||"").replace(".png","")]||"", alt: "",
                      style: {width:"100%", height:"100%", objectFit:"cover"},})
                  )
                  , React.createElement('div', { style: {fontSize:9, fontFamily:"monospace", color:"#fff", marginTop:3},}, _optionalChain([oppUnitsKept, 'access', _138 => _138[clashStep], 'optionalAccess', _139 => _139.name]))
                )
              )

              , React.createElement('button', { onClick: advanceStep, disabled: clashMyAck, style: {
                width:"100%", padding:"12px 0", borderRadius:9,
                cursor: clashMyAck ? "not-allowed" : "pointer",
                background:"rgba(0,245,255,0.08)", border:"1px solid rgba(0,245,255,0.3)",
                color:C.cyan, fontFamily:"monospace", fontSize:13, fontWeight:700,
                opacity: clashMyAck ? 0.5 : 1,
              },}, clashMyAck
                ? (isPT ? "Aguardando oponente..." : "Waiting for opponent...")
                : (isPT ? "Revelar →" : "Reveal →"))
            )
      ...
      React.createElement('div', { style: S.root,}
        , React.createElement('div', { style: {...S.content, paddingBottom:"2rem"},}
          ...
          , React.createElement('div', { style: {...S.card, border:"1px solid rgba(255,40,60,0.3)", background:"rgba(50,0,10,0.35)", marginBottom:8},}
            ...
            , React.createElement('div', { style: {fontFamily:"monospace", fontSize:18, fontWeight:800, color:"#ff4466"},}, "HP " , Math.max(0, _nullishCoalesce(_optionalChain([oppState, 'optionalAccess', _140 => _140.hp]), () => ( 0))))
            , React.createElement('div', { style: {fontFamily:"monospace", fontSize:11, color:C.textMuted},}, "AP " , _nullishCoalesce(_optionalChain([oppState, 'optionalAccess', _141 => _141.ap]), () => ( 0)))
          )
          ...
          , React.createElement('div', { style: {textAlign:"center", fontFamily:"monospace", fontSize:11, color: myTurn ? C.cyan : C.textMuted, fontWeight:700, marginBottom:8},}
            , myTurn ? `▶ ${isPT ? "SEU TURNO" : "YOUR TURN"}` : `▶ ${isPT ? "TURNO DO OPONENTE" : "OPPONENT'S TURN"}`
            , " · ", isPT ? "TURNO " : "TURN ", battle.turn
          )
          ...
          , React.createElement('div', { style: {...S.card, border:`1px solid ${C.border}`, background:"rgba(0,10,60,0.45)", marginBottom:14},}
            ...
            , React.createElement('div', { style: {fontFamily:"monospace", fontSize:18, fontWeight:800, color:C.cyan},}, "HP " , Math.max(0, _nullishCoalesce(_optionalChain([myState, 'optionalAccess', _142 => _142.hp]), () => ( 0))))
            , React.createElement('div', { style: {fontFamily:"monospace", fontSize:11, color:C.textMuted},}, "AP " , _nullishCoalesce(_optionalChain([myState, 'optionalAccess', _143 => _143.ap]), () => ( 0)))
          )
  ...
  // Fallback while battle state hasn't arrived yet
  return (
    React.createElement('div', { style: S.root,}
      , React.createElement('div', { style: {...S.content, justifyContent:"center", alignItems:"center", display:"flex", minHeight:"100vh"},}
        , React.createElement('div', { style: {fontFamily:"monospace", color:C.textMuted, fontSize:13},}
...
function GameModeScreen({ onBack, onStartAI, onStartPvp }) {
  const t = useT();
  const { settings, updateSetting } = useSettings();
...
, "⚔ " , t("gameMode.start"))
        ...
        /* VS Player card — matchmaking + room code (room code coming next) */
        , React.createElement('div', { style: {
          ...S.card,
          position:"relative",
          overflow:"hidden",
          ...
          , React.createElement('div', { style: {borderTop:"1px solid rgba(245,166,35,0.12)", paddingTop:10, display:"flex", flexDirection:"column", gap:8},}
            , React.createElement('button', {
              onClick: onStartPvp,
              style: {
                ...
                color:C.accent, fontFamily:"monospace", fontSize:13, fontWeight:700,
                letterSpacing:"0.06em",
              },}
, "🔍 " , settings.language==="pt" ? "Buscar Partida" : "Find Match")

            /* Room code — placeholder for the next iteration */
            , React.createElement('div', { style: {
              display:"flex", alignItems:"center", justifyContent:"space-between",
              ...
              , React.createElement('span', { style: {fontFamily:"monospace", fontSize:12, color:C.textMuted},}, "🔑 "
                 , settings.language==="pt" ? "Entrar com Código" : "Join with Code"
              )
              , React.createElement('span', { style: {
                fontSize:8, fontWeight:700, color:C.textMuted, fontFamily:"monospace",
...
function App() {
  ...
  // PvP connection (Socket.io, lazy-loaded, only active if PVP_SERVER_URL is set)
  const pvpConn = usePvpConnection();

  return (
    React.createElement(NickCtx.Provider, { value: { activePlayer, refreshNick, nickTick },}
    , React.createElement(PvpCtx.Provider, { value: pvpConn,}
    , React.createElement(SettingsCtx.Provider, { value: { settings, updateSetting },}
      ...
      , React.createElement('div', { style: { position:"relative", zIndex:1, minHeight:"100vh" },}
        ...
        , screen === "game"     && React.createElement(GameModeScreen, { onBack: () => setScreen("menu"), onStartAI: () => setScreen("arena"), onStartPvp: () => setScreen("pvpQueue"),} )
        , screen === "arena"    && React.createElement(ArenaPlaceholder, { onBack: () => setScreen("game"), difficulty: settings.difficulty,} )
        , screen === "pvpQueue" && React.createElement(PvpQueueScreen, { onBack: () => setScreen("game"), onMatchFound: () => setScreen("pvpArena"),} )
        , screen === "pvpArena" && React.createElement(PvpArenaPlaceholder, { onBack: () => setScreen("game"),} )
      )
    )
    )
    )
